...
const INITIAL_VERIFIED_LEADS = [
  ...
  },
  {
    ...
    "notes": "🎯 NECESIDAD: Cliente solicita presupuesto para RENOVATION_REMODEL en Vecindario en Louisville Metro / Sur de IN.\n💰 VALOR ESTIMADO: $0 USD\n🔥 URGENCIA: NORMAL\n📍 UBICACIÓN / ÁREA: Vecindario en Louisville Metro / Sur de IN\n🌐 FUENTE: Nextdoor News Feed\n🔗 ENLACE ORIGINAL: https://nextdoor.com/news_feed/\n\n=========================================\n💬 SPEECH DE VENTA RECOMENDADO (ESPAÑOL - DM):\n\"Hola Vecino: S, vi tu publicación buscando especialista en RENOVATION_REMODEL. En Barba Construction contamos con cuadrilla local en Louisville/Sur de IN y fotos de proyectos similares. Podemos pasar hoy o mañana a hacerte un estimado gratuito y sin compromiso. ¿Qué día te queda mejor?\"\n\n💬 COMENTARIO PÚBLICO SUGERIDO:\n\"Hola Vecino: S, te envié un mensaje privado con fotos de trabajos similares que hemos realizado en el área. ¡Estamos a la orden para un estimado gratis!\"\n\n💬 SALES PITCH (ENGLISH):\n\"Hi Vecino: S, saw your post regarding RENOVATION_REMODEL. We are local contractors in the Louisville/Southern IN area. We'd love to stop by for a quick, free on-site estimate. Let us know when works best for you!\"\n\n📞 APERTURA TELEFÓNICA:\n\"Hola Vecino: S, te llamo de Barba Construction con respecto a tu solicitud de cotización para RENOVATION_REMODEL.\"\n=========================================\n📄 DETALLES ORIGINALES:\nPublicación en Nextdoor: \"S\nSteve Mills\nMile of Sunshine\n·\nhace 5 días\n·\nWhy are we remodeling the Belvedere. People are staying away from Nulu or Highlands now. Businesses are leaving there too much craziness going on from people not spending mo...\"",
