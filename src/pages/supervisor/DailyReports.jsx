      ...
      <div className="crm-list">
        <table>
          ...
          <tbody>
            ...
            {reports.length===0 && <tr><td colSpan={5} className="crm-empty-row">No hay reportes aun</td></tr>}
          </tbody>
        </table>
      </div>
      {showForm && (
          ...
          <div className="modal-content crm-modal" onClick={e => e.stopPropagation()}>
            ...
            <form onSubmit={handleSubmit} className="crm-form">
              <div className="crm-form-grid">
                ...
                <div className="form-group full-width"><label>Trabajo completado *</label><textarea value={form.work_completed} onChange={e => setForm({...form,work_completed:e.target.value})} rows={4} required placeholder="Ã‚¿QuÃƒ© se hizo hoy?"/></div>
