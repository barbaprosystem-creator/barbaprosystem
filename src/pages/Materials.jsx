    ...
    <div className="admin-page p-6 lg:p-10 space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
        <div className="flex flex-col gap-2">
          <h1 className="text-3xl font-bold tracking-tight">Cat√É°logo de Materiales</h1>
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center py-20 text-[#555555] gap-4 admin-card">
          ...
          <p className="text-sm font-medium uppercase tracking-widest">Cargando cat√É°logo...</p>
        </div>
      ) : filtered.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 text-[#555555] gap-4 admin-card">
